...
export declare interface Resource extends Organization, Realease, UserInfo, Issue, PullRequest, Repository, TeamDiscussion, TeamDiscussionDiscussion, Commit, CheckRun, Milestone, RepositoryTopic, PullRequestComment, Mannequin, Bot, ClosedEvent, CrossReferencedEvent, MergedEvent, CrossReferencedEvent,
